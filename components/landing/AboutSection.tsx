...
export default function AboutSection() {
  return (
    <section id="about" className="bg-background px-6 py-24 mx-4" dir="rtl">
        ...
        <div className="flex flex-col gap-16 md:flex-row md:items-center">
          ...
          <div className="flex flex-1 flex-col items-start space-y-6 text-right">
            ...
            <div className="space-y-4 text-base leading-8 text-muted-foreground m-0 p-0">
              <p>
                نحن منصة Wasiyati، مساحة رقمية صُمّمت لتجعل إنشاء الوصية أمرًا
                بسيطًا ومريحًا للجميع. نؤمن أن تنظيم الحقوق والممتلكات يجب أن
                يكون خطوة سهلة، بعيدة عن التعقيد والإجراءات المرهقة.
              </p>
              <p>
                هدفنا هو أن نمنحك راحة البال من خلال أدوات تساعدك على التعبير عن
                وصيتك بطريقة صحيحة ومنظمة، وفقاً لأحكام الشريعة والقانون. رؤيتنا
                هي أن نصبح المرجع الرقمي الأول في مجال الوصايا الإلكترونية
                بموثوقية وأمان.
              </p>
            </div>
